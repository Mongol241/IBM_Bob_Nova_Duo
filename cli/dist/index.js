...
program
    .name("conflict-cli")
    .description("Finds merge conflicts in a repo, resolves them via Bob Shell, and emits structured ticket JSON.")
    .version("0.1.0");
program
    .command("resolve")
    .description("Scan a repo for merge conflicts, call Bob Shell per conflict, and print ticket JSON to stdout.")
...
program
    .command("apply")
    .description("Apply a single approved resolution from a ticket JSON file to its source file.")
